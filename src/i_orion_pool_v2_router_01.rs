pub use i_orion_pool_v2_router_01::*;
#[allow(
...
pub mod i_orion_pool_v2_router_01 {
    ...
    //!IOrionPoolV2Router01 was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    pub static IORIONPOOLV2ROUTER01_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct IOrionPoolV2Router01<M>(::ethers::contract::Contract<M>);
    impl<M> Clone for IOrionPoolV2Router01<M> {
        fn clone(&self) -> Self {
            IOrionPoolV2Router01(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for IOrionPoolV2Router01<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for IOrionPoolV2Router01<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(IOrionPoolV2Router01))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IOrionPoolV2Router01<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(::ethers::contract::Contract::new(
                address.into(),
                IORIONPOOLV2ROUTER01_ABI.clone(),
                client,
            ))
        }
    ...
    pub enum IOrionPoolV2Router01Calls {
        Weth(WethCall),
    ...
    impl ::ethers::core::abi::AbiDecode for IOrionPoolV2Router01Calls {
        fn decode(
            ...
            {
                return Ok(IOrionPoolV2Router01Calls::RemoveLiquidityETHWithPermit(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IOrionPoolV2Router01Calls::RemoveLiquidityWithPermit(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IOrionPoolV2Router01Calls::SwapETHForExactTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapExactETHForTokensCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IOrionPoolV2Router01Calls::SwapExactETHForTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapExactTokensForETHCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IOrionPoolV2Router01Calls::SwapExactTokensForETH(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IOrionPoolV2Router01Calls::SwapExactTokensForTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapTokensForExactETHCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IOrionPoolV2Router01Calls::SwapTokensForExactETH(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IOrionPoolV2Router01Calls::SwapTokensForExactTokens(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for IOrionPoolV2Router01Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                IOrionPoolV2Router01Calls::Weth(element) => element.encode(),
                IOrionPoolV2Router01Calls::AddLiquidity(element) => element.encode(),
                IOrionPoolV2Router01Calls::AddLiquidityETH(element) => element.encode(),
                IOrionPoolV2Router01Calls::Factory(element) => element.encode(),
                IOrionPoolV2Router01Calls::GetAmountIn(element) => element.encode(),
                IOrionPoolV2Router01Calls::GetAmountOut(element) => element.encode(),
                IOrionPoolV2Router01Calls::GetAmountsIn(element) => element.encode(),
                IOrionPoolV2Router01Calls::GetAmountsOut(element) => element.encode(),
                IOrionPoolV2Router01Calls::Quote(element) => element.encode(),
                IOrionPoolV2Router01Calls::RemoveLiquidity(element) => element.encode(),
                IOrionPoolV2Router01Calls::RemoveLiquidityETH(element) => element.encode(),
                IOrionPoolV2Router01Calls::RemoveLiquidityETHWithPermit(element) => {
                    element.encode()
                }
                IOrionPoolV2Router01Calls::RemoveLiquidityWithPermit(element) => element.encode(),
                IOrionPoolV2Router01Calls::SwapETHForExactTokens(element) => element.encode(),
                IOrionPoolV2Router01Calls::SwapExactETHForTokens(element) => element.encode(),
                IOrionPoolV2Router01Calls::SwapExactTokensForETH(element) => element.encode(),
                IOrionPoolV2Router01Calls::SwapExactTokensForTokens(element) => element.encode(),
                IOrionPoolV2Router01Calls::SwapTokensForExactETH(element) => element.encode(),
                IOrionPoolV2Router01Calls::SwapTokensForExactTokens(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for IOrionPoolV2Router01Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IOrionPoolV2Router01Calls::Weth(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::AddLiquidity(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::AddLiquidityETH(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::Factory(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::GetAmountIn(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::GetAmountOut(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::GetAmountsIn(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::GetAmountsOut(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::Quote(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::RemoveLiquidity(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::RemoveLiquidityETH(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::RemoveLiquidityETHWithPermit(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::RemoveLiquidityWithPermit(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::SwapETHForExactTokens(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::SwapExactETHForTokens(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::SwapExactTokensForETH(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::SwapExactTokensForTokens(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::SwapTokensForExactETH(element) => element.fmt(f),
                IOrionPoolV2Router01Calls::SwapTokensForExactTokens(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<WethCall> for IOrionPoolV2Router01Calls {
        fn from(var: WethCall) -> Self {
            IOrionPoolV2Router01Calls::Weth(var)
        }
    }
    impl ::std::convert::From<AddLiquidityCall> for IOrionPoolV2Router01Calls {
        fn from(var: AddLiquidityCall) -> Self {
            IOrionPoolV2Router01Calls::AddLiquidity(var)
        }
    }
    impl ::std::convert::From<AddLiquidityETHCall> for IOrionPoolV2Router01Calls {
        fn from(var: AddLiquidityETHCall) -> Self {
            IOrionPoolV2Router01Calls::AddLiquidityETH(var)
        }
    }
    impl ::std::convert::From<FactoryCall> for IOrionPoolV2Router01Calls {
        fn from(var: FactoryCall) -> Self {
            IOrionPoolV2Router01Calls::Factory(var)
        }
    }
    impl ::std::convert::From<GetAmountInCall> for IOrionPoolV2Router01Calls {
        fn from(var: GetAmountInCall) -> Self {
            IOrionPoolV2Router01Calls::GetAmountIn(var)
        }
    }
    impl ::std::convert::From<GetAmountOutCall> for IOrionPoolV2Router01Calls {
        fn from(var: GetAmountOutCall) -> Self {
            IOrionPoolV2Router01Calls::GetAmountOut(var)
        }
    }
    impl ::std::convert::From<GetAmountsInCall> for IOrionPoolV2Router01Calls {
        fn from(var: GetAmountsInCall) -> Self {
            IOrionPoolV2Router01Calls::GetAmountsIn(var)
        }
    }
    impl ::std::convert::From<GetAmountsOutCall> for IOrionPoolV2Router01Calls {
        fn from(var: GetAmountsOutCall) -> Self {
            IOrionPoolV2Router01Calls::GetAmountsOut(var)
        }
    }
    impl ::std::convert::From<QuoteCall> for IOrionPoolV2Router01Calls {
        fn from(var: QuoteCall) -> Self {
            IOrionPoolV2Router01Calls::Quote(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityCall> for IOrionPoolV2Router01Calls {
        fn from(var: RemoveLiquidityCall) -> Self {
            IOrionPoolV2Router01Calls::RemoveLiquidity(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHCall> for IOrionPoolV2Router01Calls {
        fn from(var: RemoveLiquidityETHCall) -> Self {
            IOrionPoolV2Router01Calls::RemoveLiquidityETH(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHWithPermitCall> for IOrionPoolV2Router01Calls {
        fn from(var: RemoveLiquidityETHWithPermitCall) -> Self {
            IOrionPoolV2Router01Calls::RemoveLiquidityETHWithPermit(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityWithPermitCall> for IOrionPoolV2Router01Calls {
        fn from(var: RemoveLiquidityWithPermitCall) -> Self {
            IOrionPoolV2Router01Calls::RemoveLiquidityWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapETHForExactTokensCall> for IOrionPoolV2Router01Calls {
        fn from(var: SwapETHForExactTokensCall) -> Self {
            IOrionPoolV2Router01Calls::SwapETHForExactTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactETHForTokensCall> for IOrionPoolV2Router01Calls {
        fn from(var: SwapExactETHForTokensCall) -> Self {
            IOrionPoolV2Router01Calls::SwapExactETHForTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForETHCall> for IOrionPoolV2Router01Calls {
        fn from(var: SwapExactTokensForETHCall) -> Self {
            IOrionPoolV2Router01Calls::SwapExactTokensForETH(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForTokensCall> for IOrionPoolV2Router01Calls {
        fn from(var: SwapExactTokensForTokensCall) -> Self {
            IOrionPoolV2Router01Calls::SwapExactTokensForTokens(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactETHCall> for IOrionPoolV2Router01Calls {
        fn from(var: SwapTokensForExactETHCall) -> Self {
            IOrionPoolV2Router01Calls::SwapTokensForExactETH(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactTokensCall> for IOrionPoolV2Router01Calls {
        fn from(var: SwapTokensForExactTokensCall) -> Self {
            IOrionPoolV2Router01Calls::SwapTokensForExactTokens(var)
        }
    }
