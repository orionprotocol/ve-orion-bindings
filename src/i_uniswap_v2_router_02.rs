...
pub mod i_uniswap_v2_router_02 {
    ...
    //!IUniswapV2Router02 was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    impl ::ethers::core::abi::AbiEncode for IUniswapV2Router02Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                IUniswapV2Router02Calls::Weth(element) => element.encode(),
                IUniswapV2Router02Calls::AddLiquidity(element) => element.encode(),
                IUniswapV2Router02Calls::AddLiquidityETH(element) => element.encode(),
                IUniswapV2Router02Calls::Factory(element) => element.encode(),
                IUniswapV2Router02Calls::GetAmountIn(element) => element.encode(),
                IUniswapV2Router02Calls::GetAmountOut(element) => element.encode(),
                IUniswapV2Router02Calls::GetAmountsIn(element) => element.encode(),
                IUniswapV2Router02Calls::GetAmountsOut(element) => element.encode(),
                IUniswapV2Router02Calls::Quote(element) => element.encode(),
                IUniswapV2Router02Calls::RemoveLiquidity(element) => element.encode(),
                IUniswapV2Router02Calls::RemoveLiquidityETH(element) => element.encode(),
                IUniswapV2Router02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IUniswapV2Router02Calls::RemoveLiquidityETHWithPermit(element) => {
                    element.encode()
                }
                IUniswapV2Router02Calls::RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IUniswapV2Router02Calls::RemoveLiquidityWithPermit(element) => {
                    element.encode()
                }
                IUniswapV2Router02Calls::SwapETHForExactTokens(element) => {
                    element.encode()
                }
                IUniswapV2Router02Calls::SwapExactETHForTokens(element) => {
                    element.encode()
                }
                IUniswapV2Router02Calls::SwapExactETHForTokensSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IUniswapV2Router02Calls::SwapExactTokensForETH(element) => {
                    element.encode()
                }
                IUniswapV2Router02Calls::SwapExactTokensForETHSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IUniswapV2Router02Calls::SwapExactTokensForTokens(element) => {
                    element.encode()
                }
                IUniswapV2Router02Calls::SwapExactTokensForTokensSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IUniswapV2Router02Calls::SwapTokensForExactETH(element) => {
                    element.encode()
                }
                IUniswapV2Router02Calls::SwapTokensForExactTokens(element) => {
                    element.encode()
                }
            }
        }
    ...
    impl ::std::fmt::Display for IUniswapV2Router02Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IUniswapV2Router02Calls::Weth(element) => element.fmt(f),
                IUniswapV2Router02Calls::AddLiquidity(element) => element.fmt(f),
                IUniswapV2Router02Calls::AddLiquidityETH(element) => element.fmt(f),
                IUniswapV2Router02Calls::Factory(element) => element.fmt(f),
                IUniswapV2Router02Calls::GetAmountIn(element) => element.fmt(f),
                IUniswapV2Router02Calls::GetAmountOut(element) => element.fmt(f),
                IUniswapV2Router02Calls::GetAmountsIn(element) => element.fmt(f),
                IUniswapV2Router02Calls::GetAmountsOut(element) => element.fmt(f),
                IUniswapV2Router02Calls::Quote(element) => element.fmt(f),
                IUniswapV2Router02Calls::RemoveLiquidity(element) => element.fmt(f),
                IUniswapV2Router02Calls::RemoveLiquidityETH(element) => element.fmt(f),
                IUniswapV2Router02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(
                    element,
                ) => element.fmt(f),
                IUniswapV2Router02Calls::RemoveLiquidityETHWithPermit(element) => {
                ...
                IUniswapV2Router02Calls::SwapETHForExactTokens(element) => element.fmt(f),
                IUniswapV2Router02Calls::SwapExactETHForTokens(element) => element.fmt(f),
                IUniswapV2Router02Calls::SwapExactETHForTokensSupportingFeeOnTransferTokens(
                    element,
                ) => element.fmt(f),
                IUniswapV2Router02Calls::SwapExactTokensForETH(element) => element.fmt(f),
                IUniswapV2Router02Calls::SwapExactTokensForETHSupportingFeeOnTransferTokens(
                    element,
                ) => element.fmt(f),
                IUniswapV2Router02Calls::SwapExactTokensForTokens(element) => {
                ...
                IUniswapV2Router02Calls::SwapTokensForExactETH(element) => element.fmt(f),
                IUniswapV2Router02Calls::SwapTokensForExactTokens(element) => {
                    element.fmt(f)
                }
            }
