...
pub mod generic_token {
    ...
    //!GenericToken was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    lazy_static::lazy_static! {
            pub static ref GENERICTOKEN_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from(
            __BYTECODE.to_vec(),
        );
    }
    pub struct GenericToken<M>(::ethers::contract::Contract<M>);
    impl<M> Clone for GenericToken<M> {
        fn clone(&self) -> Self {
            GenericToken(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for GenericToken<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for GenericToken<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(GenericToken))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> GenericToken<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                GENERICTOKEN_ABI.clone(),
                GENERICTOKEN_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<M, GenericTokenEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for GenericToken<M> {
    ...
    impl ::ethers::contract::EthLogDecode for GenericTokenEvents {
        fn decode_log(
            ...
            Self: Sized,
        {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(GenericTokenEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(GenericTokenEvents::RoleAdminChangedFilter(decoded));
            }
            if let Ok(decoded) = RoleGrantedFilter::decode_log(log) {
                return Ok(GenericTokenEvents::RoleGrantedFilter(decoded));
            }
            if let Ok(decoded) = RoleRevokedFilter::decode_log(log) {
                return Ok(GenericTokenEvents::RoleRevokedFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(GenericTokenEvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::std::fmt::Display for GenericTokenEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                GenericTokenEvents::ApprovalFilter(element) => element.fmt(f),
                GenericTokenEvents::RoleAdminChangedFilter(element) => element.fmt(f),
                GenericTokenEvents::RoleGrantedFilter(element) => element.fmt(f),
                GenericTokenEvents::RoleRevokedFilter(element) => element.fmt(f),
                GenericTokenEvents::TransferFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for GenericTokenCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            {
                return Ok(GenericTokenCalls::DefaultAdminRole(decoded));
            }
            if let Ok(decoded) =
                <MinterRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::MinterRole(decoded));
            }
            if let Ok(decoded) =
                <AddMinterCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::AddMinter(decoded));
            }
            if let Ok(decoded) =
                <AllowanceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Allowance(decoded));
            }
            if let Ok(decoded) =
                <ApproveCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Approve(decoded));
            }
            if let Ok(decoded) =
                <BalanceOfCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::BalanceOf(decoded));
            }
            if let Ok(decoded) = <CapCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Cap(decoded));
            }
            if let Ok(decoded) =
                <DecimalsCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Decimals(decoded));
            }
            if let Ok(decoded) =
                <DecreaseAllowanceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::DecreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <GetRoleAdminCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::GetRoleAdmin(decoded));
            }
            if let Ok(decoded) =
                <GrantRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::GrantRole(decoded));
            }
            if let Ok(decoded) =
                <HasRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::HasRole(decoded));
            }
            if let Ok(decoded) =
                <IncreaseAllowanceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::IncreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <IsMinterCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::IsMinter(decoded));
            }
            if let Ok(decoded) = <MintCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Mint(decoded));
            }
            if let Ok(decoded) = <NameCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Name(decoded));
            }
            if let Ok(decoded) =
                <RenounceRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::RenounceRole(decoded));
            }
            if let Ok(decoded) =
                <RevokeRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::RevokeRole(decoded));
            }
            if let Ok(decoded) =
                <SupportsInterfaceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::SupportsInterface(decoded));
            }
            if let Ok(decoded) =
                <SymbolCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Symbol(decoded));
            }
            if let Ok(decoded) =
                <TotalSupplyCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::TotalSupply(decoded));
            }
            if let Ok(decoded) =
                <TransferCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::Transfer(decoded));
            }
            if let Ok(decoded) =
                <TransferFromCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(GenericTokenCalls::TransferFrom(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for GenericTokenCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                GenericTokenCalls::DefaultAdminRole(element) => element.encode(),
                GenericTokenCalls::MinterRole(element) => element.encode(),
                GenericTokenCalls::AddMinter(element) => element.encode(),
                GenericTokenCalls::Allowance(element) => element.encode(),
                GenericTokenCalls::Approve(element) => element.encode(),
                GenericTokenCalls::BalanceOf(element) => element.encode(),
                GenericTokenCalls::Cap(element) => element.encode(),
                GenericTokenCalls::Decimals(element) => element.encode(),
                GenericTokenCalls::DecreaseAllowance(element) => element.encode(),
                GenericTokenCalls::GetRoleAdmin(element) => element.encode(),
                GenericTokenCalls::GrantRole(element) => element.encode(),
                GenericTokenCalls::HasRole(element) => element.encode(),
                GenericTokenCalls::IncreaseAllowance(element) => element.encode(),
                GenericTokenCalls::IsMinter(element) => element.encode(),
                GenericTokenCalls::Mint(element) => element.encode(),
                GenericTokenCalls::Name(element) => element.encode(),
                GenericTokenCalls::RenounceRole(element) => element.encode(),
                GenericTokenCalls::RevokeRole(element) => element.encode(),
                GenericTokenCalls::SupportsInterface(element) => element.encode(),
                GenericTokenCalls::Symbol(element) => element.encode(),
                GenericTokenCalls::TotalSupply(element) => element.encode(),
                GenericTokenCalls::Transfer(element) => element.encode(),
                GenericTokenCalls::TransferFrom(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for GenericTokenCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                GenericTokenCalls::DefaultAdminRole(element) => element.fmt(f),
                GenericTokenCalls::MinterRole(element) => element.fmt(f),
                GenericTokenCalls::AddMinter(element) => element.fmt(f),
                GenericTokenCalls::Allowance(element) => element.fmt(f),
                GenericTokenCalls::Approve(element) => element.fmt(f),
                GenericTokenCalls::BalanceOf(element) => element.fmt(f),
                GenericTokenCalls::Cap(element) => element.fmt(f),
                GenericTokenCalls::Decimals(element) => element.fmt(f),
                GenericTokenCalls::DecreaseAllowance(element) => element.fmt(f),
                GenericTokenCalls::GetRoleAdmin(element) => element.fmt(f),
                GenericTokenCalls::GrantRole(element) => element.fmt(f),
                GenericTokenCalls::HasRole(element) => element.fmt(f),
                GenericTokenCalls::IncreaseAllowance(element) => element.fmt(f),
                GenericTokenCalls::IsMinter(element) => element.fmt(f),
                GenericTokenCalls::Mint(element) => element.fmt(f),
                GenericTokenCalls::Name(element) => element.fmt(f),
                GenericTokenCalls::RenounceRole(element) => element.fmt(f),
                GenericTokenCalls::RevokeRole(element) => element.fmt(f),
                GenericTokenCalls::SupportsInterface(element) => element.fmt(f),
                GenericTokenCalls::Symbol(element) => element.fmt(f),
                GenericTokenCalls::TotalSupply(element) => element.fmt(f),
                GenericTokenCalls::Transfer(element) => element.fmt(f),
                GenericTokenCalls::TransferFrom(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<DefaultAdminRoleCall> for GenericTokenCalls {
        fn from(var: DefaultAdminRoleCall) -> Self {
            GenericTokenCalls::DefaultAdminRole(var)
        }
    }
    impl ::std::convert::From<MinterRoleCall> for GenericTokenCalls {
        fn from(var: MinterRoleCall) -> Self {
            GenericTokenCalls::MinterRole(var)
        }
    }
    impl ::std::convert::From<AddMinterCall> for GenericTokenCalls {
        fn from(var: AddMinterCall) -> Self {
            GenericTokenCalls::AddMinter(var)
        }
    }
    impl ::std::convert::From<AllowanceCall> for GenericTokenCalls {
        fn from(var: AllowanceCall) -> Self {
            GenericTokenCalls::Allowance(var)
        }
    }
    impl ::std::convert::From<ApproveCall> for GenericTokenCalls {
        fn from(var: ApproveCall) -> Self {
            GenericTokenCalls::Approve(var)
        }
    }
    impl ::std::convert::From<BalanceOfCall> for GenericTokenCalls {
        fn from(var: BalanceOfCall) -> Self {
            GenericTokenCalls::BalanceOf(var)
        }
    }
    impl ::std::convert::From<CapCall> for GenericTokenCalls {
        fn from(var: CapCall) -> Self {
            GenericTokenCalls::Cap(var)
        }
    }
    impl ::std::convert::From<DecimalsCall> for GenericTokenCalls {
        fn from(var: DecimalsCall) -> Self {
            GenericTokenCalls::Decimals(var)
        }
    }
    impl ::std::convert::From<DecreaseAllowanceCall> for GenericTokenCalls {
        fn from(var: DecreaseAllowanceCall) -> Self {
            GenericTokenCalls::DecreaseAllowance(var)
        }
    }
    impl ::std::convert::From<GetRoleAdminCall> for GenericTokenCalls {
        fn from(var: GetRoleAdminCall) -> Self {
            GenericTokenCalls::GetRoleAdmin(var)
        }
    }
    impl ::std::convert::From<GrantRoleCall> for GenericTokenCalls {
        fn from(var: GrantRoleCall) -> Self {
            GenericTokenCalls::GrantRole(var)
        }
    }
    impl ::std::convert::From<HasRoleCall> for GenericTokenCalls {
        fn from(var: HasRoleCall) -> Self {
            GenericTokenCalls::HasRole(var)
        }
    }
    impl ::std::convert::From<IncreaseAllowanceCall> for GenericTokenCalls {
        fn from(var: IncreaseAllowanceCall) -> Self {
            GenericTokenCalls::IncreaseAllowance(var)
        }
    }
    impl ::std::convert::From<IsMinterCall> for GenericTokenCalls {
        fn from(var: IsMinterCall) -> Self {
            GenericTokenCalls::IsMinter(var)
        }
    }
    impl ::std::convert::From<MintCall> for GenericTokenCalls {
        fn from(var: MintCall) -> Self {
            GenericTokenCalls::Mint(var)
        }
    }
    impl ::std::convert::From<NameCall> for GenericTokenCalls {
        fn from(var: NameCall) -> Self {
            GenericTokenCalls::Name(var)
        }
    }
    impl ::std::convert::From<RenounceRoleCall> for GenericTokenCalls {
        fn from(var: RenounceRoleCall) -> Self {
            GenericTokenCalls::RenounceRole(var)
        }
    }
    impl ::std::convert::From<RevokeRoleCall> for GenericTokenCalls {
        fn from(var: RevokeRoleCall) -> Self {
            GenericTokenCalls::RevokeRole(var)
        }
    }
    impl ::std::convert::From<SupportsInterfaceCall> for GenericTokenCalls {
        fn from(var: SupportsInterfaceCall) -> Self {
            GenericTokenCalls::SupportsInterface(var)
        }
    }
    impl ::std::convert::From<SymbolCall> for GenericTokenCalls {
        fn from(var: SymbolCall) -> Self {
            GenericTokenCalls::Symbol(var)
        }
    }
    impl ::std::convert::From<TotalSupplyCall> for GenericTokenCalls {
        fn from(var: TotalSupplyCall) -> Self {
            GenericTokenCalls::TotalSupply(var)
        }
    }
    impl ::std::convert::From<TransferCall> for GenericTokenCalls {
        fn from(var: TransferCall) -> Self {
            GenericTokenCalls::Transfer(var)
        }
    }
    impl ::std::convert::From<TransferFromCall> for GenericTokenCalls {
        fn from(var: TransferFromCall) -> Self {
            GenericTokenCalls::TransferFrom(var)
        }
    }
