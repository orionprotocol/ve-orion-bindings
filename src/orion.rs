...
pub mod orion {
    ...
    //!Orion was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    pub static ORION_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    lazy_static::lazy_static! {
            pub static ref ORION_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from(
            __BYTECODE.to_vec(),
        );
    }
    pub struct Orion<M>(::ethers::contract::Contract<M>);
    impl<M> Clone for Orion<M> {
        fn clone(&self) -> Self {
            Orion(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for Orion<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for Orion<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(Orion))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Orion<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<M, OrionEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for Orion<M> {
    ...
    impl ::ethers::contract::EthLogDecode for OrionEvents {
        fn decode_log(
            ...
            Self: Sized,
        {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(OrionEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(OrionEvents::RoleAdminChangedFilter(decoded));
            }
            if let Ok(decoded) = RoleGrantedFilter::decode_log(log) {
                return Ok(OrionEvents::RoleGrantedFilter(decoded));
            }
            if let Ok(decoded) = RoleRevokedFilter::decode_log(log) {
                return Ok(OrionEvents::RoleRevokedFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(OrionEvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::std::fmt::Display for OrionEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                OrionEvents::ApprovalFilter(element) => element.fmt(f),
                OrionEvents::RoleAdminChangedFilter(element) => element.fmt(f),
                OrionEvents::RoleGrantedFilter(element) => element.fmt(f),
                OrionEvents::RoleRevokedFilter(element) => element.fmt(f),
                OrionEvents::TransferFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for OrionCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            {
                return Ok(OrionCalls::DefaultAdminRole(decoded));
            }
            if let Ok(decoded) =
                <MinterRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::MinterRole(decoded));
            }
            if let Ok(decoded) =
                <AddMinterCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::AddMinter(decoded));
            }
            if let Ok(decoded) =
                <AllowanceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Allowance(decoded));
            }
            if let Ok(decoded) =
                <ApproveCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Approve(decoded));
            }
            if let Ok(decoded) =
                <BalanceOfCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::BalanceOf(decoded));
            }
            if let Ok(decoded) = <CapCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Cap(decoded));
            }
            if let Ok(decoded) =
                <DecimalsCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Decimals(decoded));
            }
            if let Ok(decoded) =
                <DecreaseAllowanceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::DecreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <GetRoleAdminCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::GetRoleAdmin(decoded));
            }
            if let Ok(decoded) =
                <GrantRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::GrantRole(decoded));
            }
            if let Ok(decoded) =
                <HasRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::HasRole(decoded));
            }
            if let Ok(decoded) =
                <IncreaseAllowanceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::IncreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <IsMinterCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::IsMinter(decoded));
            }
            if let Ok(decoded) = <MintCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Mint(decoded));
            }
            if let Ok(decoded) = <NameCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Name(decoded));
            }
            if let Ok(decoded) =
                <RenounceRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::RenounceRole(decoded));
            }
            if let Ok(decoded) =
                <RevokeRoleCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::RevokeRole(decoded));
            }
            if let Ok(decoded) =
                <SupportsInterfaceCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::SupportsInterface(decoded));
            }
            if let Ok(decoded) =
                <SymbolCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Symbol(decoded));
            }
            if let Ok(decoded) =
                <TotalSupplyCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::TotalSupply(decoded));
            }
            if let Ok(decoded) =
                <TransferCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::Transfer(decoded));
            }
            if let Ok(decoded) =
                <TransferFromCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(OrionCalls::TransferFrom(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for OrionCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                OrionCalls::DefaultAdminRole(element) => element.encode(),
                OrionCalls::MinterRole(element) => element.encode(),
                OrionCalls::AddMinter(element) => element.encode(),
                OrionCalls::Allowance(element) => element.encode(),
                OrionCalls::Approve(element) => element.encode(),
                OrionCalls::BalanceOf(element) => element.encode(),
                OrionCalls::Cap(element) => element.encode(),
                OrionCalls::Decimals(element) => element.encode(),
                OrionCalls::DecreaseAllowance(element) => element.encode(),
                OrionCalls::GetRoleAdmin(element) => element.encode(),
                OrionCalls::GrantRole(element) => element.encode(),
                OrionCalls::HasRole(element) => element.encode(),
                OrionCalls::IncreaseAllowance(element) => element.encode(),
                OrionCalls::IsMinter(element) => element.encode(),
                OrionCalls::Mint(element) => element.encode(),
                OrionCalls::Name(element) => element.encode(),
                OrionCalls::RenounceRole(element) => element.encode(),
                OrionCalls::RevokeRole(element) => element.encode(),
                OrionCalls::SupportsInterface(element) => element.encode(),
                OrionCalls::Symbol(element) => element.encode(),
                OrionCalls::TotalSupply(element) => element.encode(),
                OrionCalls::Transfer(element) => element.encode(),
                OrionCalls::TransferFrom(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for OrionCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                OrionCalls::DefaultAdminRole(element) => element.fmt(f),
                OrionCalls::MinterRole(element) => element.fmt(f),
                OrionCalls::AddMinter(element) => element.fmt(f),
                OrionCalls::Allowance(element) => element.fmt(f),
                OrionCalls::Approve(element) => element.fmt(f),
                OrionCalls::BalanceOf(element) => element.fmt(f),
                OrionCalls::Cap(element) => element.fmt(f),
                OrionCalls::Decimals(element) => element.fmt(f),
                OrionCalls::DecreaseAllowance(element) => element.fmt(f),
                OrionCalls::GetRoleAdmin(element) => element.fmt(f),
                OrionCalls::GrantRole(element) => element.fmt(f),
                OrionCalls::HasRole(element) => element.fmt(f),
                OrionCalls::IncreaseAllowance(element) => element.fmt(f),
                OrionCalls::IsMinter(element) => element.fmt(f),
                OrionCalls::Mint(element) => element.fmt(f),
                OrionCalls::Name(element) => element.fmt(f),
                OrionCalls::RenounceRole(element) => element.fmt(f),
                OrionCalls::RevokeRole(element) => element.fmt(f),
                OrionCalls::SupportsInterface(element) => element.fmt(f),
                OrionCalls::Symbol(element) => element.fmt(f),
                OrionCalls::TotalSupply(element) => element.fmt(f),
                OrionCalls::Transfer(element) => element.fmt(f),
                OrionCalls::TransferFrom(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<DefaultAdminRoleCall> for OrionCalls {
        fn from(var: DefaultAdminRoleCall) -> Self {
            OrionCalls::DefaultAdminRole(var)
        }
    }
    impl ::std::convert::From<MinterRoleCall> for OrionCalls {
        fn from(var: MinterRoleCall) -> Self {
            OrionCalls::MinterRole(var)
        }
    }
    impl ::std::convert::From<AddMinterCall> for OrionCalls {
        fn from(var: AddMinterCall) -> Self {
            OrionCalls::AddMinter(var)
        }
    }
    impl ::std::convert::From<AllowanceCall> for OrionCalls {
        fn from(var: AllowanceCall) -> Self {
            OrionCalls::Allowance(var)
        }
    }
    impl ::std::convert::From<ApproveCall> for OrionCalls {
        fn from(var: ApproveCall) -> Self {
            OrionCalls::Approve(var)
        }
    }
    impl ::std::convert::From<BalanceOfCall> for OrionCalls {
        fn from(var: BalanceOfCall) -> Self {
            OrionCalls::BalanceOf(var)
        }
    }
    impl ::std::convert::From<CapCall> for OrionCalls {
        fn from(var: CapCall) -> Self {
            OrionCalls::Cap(var)
        }
    }
    impl ::std::convert::From<DecimalsCall> for OrionCalls {
        fn from(var: DecimalsCall) -> Self {
            OrionCalls::Decimals(var)
        }
    }
    impl ::std::convert::From<DecreaseAllowanceCall> for OrionCalls {
        fn from(var: DecreaseAllowanceCall) -> Self {
            OrionCalls::DecreaseAllowance(var)
        }
    }
    impl ::std::convert::From<GetRoleAdminCall> for OrionCalls {
        fn from(var: GetRoleAdminCall) -> Self {
            OrionCalls::GetRoleAdmin(var)
        }
    }
    impl ::std::convert::From<GrantRoleCall> for OrionCalls {
        fn from(var: GrantRoleCall) -> Self {
            OrionCalls::GrantRole(var)
        }
    }
    impl ::std::convert::From<HasRoleCall> for OrionCalls {
        fn from(var: HasRoleCall) -> Self {
            OrionCalls::HasRole(var)
        }
    }
    impl ::std::convert::From<IncreaseAllowanceCall> for OrionCalls {
        fn from(var: IncreaseAllowanceCall) -> Self {
            OrionCalls::IncreaseAllowance(var)
        }
    }
    impl ::std::convert::From<IsMinterCall> for OrionCalls {
        fn from(var: IsMinterCall) -> Self {
            OrionCalls::IsMinter(var)
        }
    }
    impl ::std::convert::From<MintCall> for OrionCalls {
        fn from(var: MintCall) -> Self {
            OrionCalls::Mint(var)
        }
    }
    impl ::std::convert::From<NameCall> for OrionCalls {
        fn from(var: NameCall) -> Self {
            OrionCalls::Name(var)
        }
    }
    impl ::std::convert::From<RenounceRoleCall> for OrionCalls {
        fn from(var: RenounceRoleCall) -> Self {
            OrionCalls::RenounceRole(var)
        }
    }
    impl ::std::convert::From<RevokeRoleCall> for OrionCalls {
        fn from(var: RevokeRoleCall) -> Self {
            OrionCalls::RevokeRole(var)
        }
    }
    impl ::std::convert::From<SupportsInterfaceCall> for OrionCalls {
        fn from(var: SupportsInterfaceCall) -> Self {
            OrionCalls::SupportsInterface(var)
        }
    }
    impl ::std::convert::From<SymbolCall> for OrionCalls {
        fn from(var: SymbolCall) -> Self {
            OrionCalls::Symbol(var)
        }
    }
    impl ::std::convert::From<TotalSupplyCall> for OrionCalls {
        fn from(var: TotalSupplyCall) -> Self {
            OrionCalls::TotalSupply(var)
        }
    }
    impl ::std::convert::From<TransferCall> for OrionCalls {
        fn from(var: TransferCall) -> Self {
            OrionCalls::Transfer(var)
        }
    }
    impl ::std::convert::From<TransferFromCall> for OrionCalls {
        fn from(var: TransferFromCall) -> Self {
            OrionCalls::TransferFrom(var)
        }
    }
