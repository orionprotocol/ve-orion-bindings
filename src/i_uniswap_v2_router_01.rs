...
pub mod i_uniswap_v2_router_01 {
    ...
    //!IUniswapV2Router01 was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    impl<M> Clone for IUniswapV2Router01<M> {
        fn clone(&self) -> Self {
            IUniswapV2Router01(self.0.clone())
        }
    }
    ...
    impl<M> std::fmt::Debug for IUniswapV2Router01<M> {
