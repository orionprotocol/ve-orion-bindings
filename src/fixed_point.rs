...
pub mod fixed_point {
    ...
    //!FixedPoint was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    lazy_static::lazy_static! {
            pub static ref FIXEDPOINT_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from(
            __BYTECODE.to_vec(),
        );
    }
    pub struct FixedPoint<M>(::ethers::contract::Contract<M>);
    impl<M> Clone for FixedPoint<M> {
        fn clone(&self) -> Self {
            FixedPoint(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for FixedPoint<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for FixedPoint<M> {
