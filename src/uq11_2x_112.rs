...
pub mod uq11_2x_112 {
    ...
    //!UQ112x112 was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    lazy_static::lazy_static! {
            pub static ref UQ112X112_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from(
            __BYTECODE.to_vec(),
        );
    }
    ...
    impl<M> std::fmt::Debug for UQ112x112<M> {
