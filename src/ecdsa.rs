...
pub mod ecdsa {
    ...
    //!ECDSA was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    lazy_static::lazy_static! {
            pub static ref ECDSA_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from(
            __BYTECODE.to_vec(),
        );
    }
    ...
    impl<M> std::fmt::Debug for ECDSA<M> {
