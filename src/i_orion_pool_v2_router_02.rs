pub use i_orion_pool_v2_router_02::*;
#[allow(
...
pub mod i_orion_pool_v2_router_02 {
    ...
    //!IOrionPoolV2Router02 was auto-generated with ethers-rs Abigen. More information at: <https://github.com/gakonst/ethers-rs>
    use ::ethers::contract::{
    ...
    impl<M: ::ethers::providers::Middleware> IOrionPoolV2Router02<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(::ethers::contract::Contract::new(
                address.into(),
                IORIONPOOLV2ROUTER02_ABI.clone(),
                client,
            ))
        }
    ...
    pub enum IOrionPoolV2Router02Calls {
        Weth(WethCall),
    ...
    impl ::ethers::core::abi::AbiDecode for IOrionPoolV2Router02Calls {
        fn decode(
            ...
            if let Ok(decoded)
                ...
                return Ok(
                    IOrionPoolV2Router02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(
                        decoded,
                    ),
                );
            }
            ...
            {
                return Ok(IOrionPoolV2Router02Calls::RemoveLiquidityETHWithPermit(
                    decoded,
                ));
            }
            if let Ok(decoded)
                ...
                return Ok(
                    IOrionPoolV2Router02Calls::RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens(
                        decoded,
                    ),
                );
            }
            ...
            {
                return Ok(IOrionPoolV2Router02Calls::RemoveLiquidityWithPermit(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IOrionPoolV2Router02Calls::SwapETHForExactTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapExactETHForTokensCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IOrionPoolV2Router02Calls::SwapExactETHForTokens(decoded));
            }
            if let Ok(decoded)
                ...
                return Ok(
                    IOrionPoolV2Router02Calls::SwapExactETHForTokensSupportingFeeOnTransferTokens(
                        decoded,
                    ),
                );
            }
            ...
            {
                return Ok(IOrionPoolV2Router02Calls::SwapExactTokensForETH(decoded));
            }
            if let Ok(decoded)
                ...
                return Ok(
                    IOrionPoolV2Router02Calls::SwapExactTokensForETHSupportingFeeOnTransferTokens(
                        decoded,
                    ),
                );
            }
            ...
            {
                return Ok(IOrionPoolV2Router02Calls::SwapExactTokensForTokens(decoded));
            }
            if let Ok(decoded)
                ...
                return Ok(
                    IOrionPoolV2Router02Calls::SwapExactTokensForTokensSupportingFeeOnTransferTokens(
                        decoded,
                    ),
                );
            }
            ...
            {
                return Ok(IOrionPoolV2Router02Calls::SwapTokensForExactETH(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IOrionPoolV2Router02Calls::SwapTokensForExactTokens(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for IOrionPoolV2Router02Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                IOrionPoolV2Router02Calls::Weth(element) => element.encode(),
                IOrionPoolV2Router02Calls::AddLiquidity(element) => element.encode(),
                IOrionPoolV2Router02Calls::AddLiquidityETH(element) => element.encode(),
                IOrionPoolV2Router02Calls::Factory(element) => element.encode(),
                IOrionPoolV2Router02Calls::GetAmountIn(element) => element.encode(),
                IOrionPoolV2Router02Calls::GetAmountOut(element) => element.encode(),
                IOrionPoolV2Router02Calls::GetAmountsIn(element) => element.encode(),
                IOrionPoolV2Router02Calls::GetAmountsOut(element) => element.encode(),
                IOrionPoolV2Router02Calls::Quote(element) => element.encode(),
                IOrionPoolV2Router02Calls::RemoveLiquidity(element) => element.encode(),
                IOrionPoolV2Router02Calls::RemoveLiquidityETH(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IOrionPoolV2Router02Calls::RemoveLiquidityETHWithPermit(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IOrionPoolV2Router02Calls::RemoveLiquidityWithPermit(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::SwapETHForExactTokens(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::SwapExactETHForTokens(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::SwapExactETHForTokensSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IOrionPoolV2Router02Calls::SwapExactTokensForETH(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::SwapExactTokensForETHSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IOrionPoolV2Router02Calls::SwapExactTokensForTokens(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::SwapExactTokensForTokensSupportingFeeOnTransferTokens(
                    element,
                ) => element.encode(),
                IOrionPoolV2Router02Calls::SwapTokensForExactETH(element) => {
                    element.encode()
                }
                IOrionPoolV2Router02Calls::SwapTokensForExactTokens(element) => {
                    element.encode()
                }
            }
        }
    }
    impl ::std::fmt::Display for IOrionPoolV2Router02Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IOrionPoolV2Router02Calls::Weth(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::AddLiquidity(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::AddLiquidityETH(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::Factory(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::GetAmountIn(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::GetAmountOut(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::GetAmountsIn(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::GetAmountsOut(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::Quote(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::RemoveLiquidity(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::RemoveLiquidityETH(element) => element.fmt(f),
                IOrionPoolV2Router02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(
                    element,
                ) => element.fmt(f),
                IOrionPoolV2Router02Calls::RemoveLiquidityETHWithPermit(element) => {
    ...
    impl ::std::convert::From<WethCall> for IOrionPoolV2Router02Calls {
        fn from(var: WethCall) -> Self {
            IOrionPoolV2Router02Calls::Weth(var)
        }
    }
    impl ::std::convert::From<AddLiquidityCall> for IOrionPoolV2Router02Calls {
        fn from(var: AddLiquidityCall) -> Self {
            IOrionPoolV2Router02Calls::AddLiquidity(var)
        }
    }
    impl ::std::convert::From<AddLiquidityETHCall> for IOrionPoolV2Router02Calls {
        fn from(var: AddLiquidityETHCall) -> Self {
            IOrionPoolV2Router02Calls::AddLiquidityETH(var)
        }
    }
    impl ::std::convert::From<FactoryCall> for IOrionPoolV2Router02Calls {
        fn from(var: FactoryCall) -> Self {
            IOrionPoolV2Router02Calls::Factory(var)
        }
    }
    impl ::std::convert::From<GetAmountInCall> for IOrionPoolV2Router02Calls {
        fn from(var: GetAmountInCall) -> Self {
            IOrionPoolV2Router02Calls::GetAmountIn(var)
        }
    }
    impl ::std::convert::From<GetAmountOutCall> for IOrionPoolV2Router02Calls {
        fn from(var: GetAmountOutCall) -> Self {
            IOrionPoolV2Router02Calls::GetAmountOut(var)
        }
    }
    impl ::std::convert::From<GetAmountsInCall> for IOrionPoolV2Router02Calls {
        fn from(var: GetAmountsInCall) -> Self {
            IOrionPoolV2Router02Calls::GetAmountsIn(var)
        }
    }
    impl ::std::convert::From<GetAmountsOutCall> for IOrionPoolV2Router02Calls {
        fn from(var: GetAmountsOutCall) -> Self {
            IOrionPoolV2Router02Calls::GetAmountsOut(var)
        }
    }
    impl ::std::convert::From<QuoteCall> for IOrionPoolV2Router02Calls {
        fn from(var: QuoteCall) -> Self {
            IOrionPoolV2Router02Calls::Quote(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityCall> for IOrionPoolV2Router02Calls {
        fn from(var: RemoveLiquidityCall) -> Self {
            IOrionPoolV2Router02Calls::RemoveLiquidity(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHCall> for IOrionPoolV2Router02Calls {
        fn from(var: RemoveLiquidityETHCall) -> Self {
            IOrionPoolV2Router02Calls::RemoveLiquidityETH(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHSupportingFeeOnTransferTokensCall>
        for IOrionPoolV2Router02Calls
    {
        fn from(var: RemoveLiquidityETHSupportingFeeOnTransferTokensCall) -> Self {
            IOrionPoolV2Router02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHWithPermitCall> for IOrionPoolV2Router02Calls {
        fn from(var: RemoveLiquidityETHWithPermitCall) -> Self {
            IOrionPoolV2Router02Calls::RemoveLiquidityETHWithPermit(var)
        }
    }
    ...
    impl ::std::convert::From<RemoveLiquidityWithPermitCall> for IOrionPoolV2Router02Calls {
        fn from(var: RemoveLiquidityWithPermitCall) -> Self {
            IOrionPoolV2Router02Calls::RemoveLiquidityWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapETHForExactTokensCall> for IOrionPoolV2Router02Calls {
        fn from(var: SwapETHForExactTokensCall) -> Self {
            IOrionPoolV2Router02Calls::SwapETHForExactTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactETHForTokensCall> for IOrionPoolV2Router02Calls {
        fn from(var: SwapExactETHForTokensCall) -> Self {
            IOrionPoolV2Router02Calls::SwapExactETHForTokens(var)
        }
    }
        ...
        for IOrionPoolV2Router02Calls
    {
        fn from(var: SwapExactETHForTokensSupportingFeeOnTransferTokensCall) -> Self {
            IOrionPoolV2Router02Calls::SwapExactETHForTokensSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForETHCall> for IOrionPoolV2Router02Calls {
        fn from(var: SwapExactTokensForETHCall) -> Self {
            IOrionPoolV2Router02Calls::SwapExactTokensForETH(var)
        }
    }
        ...
        for IOrionPoolV2Router02Calls
    {
        fn from(var: SwapExactTokensForETHSupportingFeeOnTransferTokensCall) -> Self {
            IOrionPoolV2Router02Calls::SwapExactTokensForETHSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForTokensCall> for IOrionPoolV2Router02Calls {
        fn from(var: SwapExactTokensForTokensCall) -> Self {
            IOrionPoolV2Router02Calls::SwapExactTokensForTokens(var)
        }
    }
        ...
        for IOrionPoolV2Router02Calls
    {
        fn from(var: SwapExactTokensForTokensSupportingFeeOnTransferTokensCall) -> Self {
            IOrionPoolV2Router02Calls::SwapExactTokensForTokensSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactETHCall> for IOrionPoolV2Router02Calls {
        fn from(var: SwapTokensForExactETHCall) -> Self {
            IOrionPoolV2Router02Calls::SwapTokensForExactETH(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactTokensCall> for IOrionPoolV2Router02Calls {
        fn from(var: SwapTokensForExactTokensCall) -> Self {
            IOrionPoolV2Router02Calls::SwapTokensForExactTokens(var)
        }
    }
